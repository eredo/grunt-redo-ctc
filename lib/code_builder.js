...
CodeBuilder.prototype = {
   ...
   */
  getDomAttributes: function(attributes) {
    var obj = {};
   ...
   * @param {string=} opt_class The css class of the tag.
   * @param {string=} opt_content The content of the dom.
   * @returns {string}
   */
  getCreateDom: function(varname, tagName, opt_domHelper, opt_class, opt_content) {
    if (opt_class) {
   ...
   * @returns {CodeBuilder}
   */
  createDom: function(varname, tagName, opt_domHelper, opt_class, opt_content) {
    this.code_ += this.getCreateDom(varname, tagName, opt_domHelper, opt_class, opt_content);
    return this;
  },
